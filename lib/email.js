...
// ============================================================
export async function sendKontoGodkantTillBolag({ to, companyName, companyId }) {
  const html = renderEmail({
    ...
    bodyHtml: `
      ...
      <p style="margin:0 0 16px;">Er profil finns på ${SITE}/bolag/${companyId}.</p>
    `,
...
Er profil: ${SITE}/bolag/${companyId}
